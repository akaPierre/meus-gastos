            ...
            <Card.Body>
                ...
                {!hideButtons && (
                    <Stack direction="horizontal" gap="2" className="mt-4">
                        <Button variant="outline-primary" className="ms-auto" onClick={onAddExpenseClick}>Adicionar Despesa</Button>
                        <Button onClick={onViewExpensesClick} variant="outline-secondary">Ver Despesas</Button>
                    </Stack>
                )}
            </Card.Body>
        </Card>
